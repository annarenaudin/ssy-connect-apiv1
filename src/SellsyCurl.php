<?php
namespace AnnaRen\SsyConnect;

class SellsyCurl {
	private static $api_url = "https://apifeed.sellsy.com/0/";
	private static $oauth_access_token = SELLSY_API_ACCESS_TOKEN;
	private static $oauth_access_token_secret	= SELLSY_API_ACCESS_SECRET;
	private static $oauth_consumer_key = SELLSY_API_CONSUMER_TOKEN;
	private static $oauth_consumer_secret = SELLSY_API_CONSUMER_SECRET;
	...
	private function __construct() {
		...
		$this->header = [self::getHeaders($oauth_params), 'Expect:'];
	}
